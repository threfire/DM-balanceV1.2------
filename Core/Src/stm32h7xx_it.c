...
void HardFault_Handler(void)
{
  ...
  while (1)
  {
    /* USER CODE BEGIN W1_HardFault_IRQn 0 */
		HAL_NVIC_SystemReset();   // �?终仍是写 AIRCR，只是加了钥匙序�?
...
/**
  ...
  * @brief EXTI line0 interrupt handler (PA0 -> CAM_TRIG)
...
/**
  ...
  *        Called by HAL_GPIO_EXTI_IRQHandler after edge detection.
...
//  if (GPIO_Pin == CAM_TRIG_Pin) {

//    /* Camera trigger pulse detected */
