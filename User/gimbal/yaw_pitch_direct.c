...
__attribute__((used))void gimbal_init(gimbal_control_t *init)
{
    ...
    //��ʼ��yaw���pid
    gimbal_PID_init(&init->gimbal_yaw_motor.gimbal_motor_absolute_angle_pid, HERO_YAW_GYRO_ABSOLUTE_PID_MAX_OUT, HERO_YAW_GYRO_ABSOLUTE_PID_MAX_IOUT, HERO_YAW_GYRO_ABSOLUTE_PID_KP, HERO_YAW_GYRO_ABSOLUTE_PID_KI, HERO_YAW_GYRO_ABSOLUTE_PID_KD);
    gimbal_PID_init(&init->gimbal_yaw_motor.gimbal_motor_relative_angle_pid, HERO_YAW_ENCODE_RELATIVE_PID_MAX_OUT, HERO_YAW_ENCODE_RELATIVE_PID_MAX_IOUT, HERO_YAW_ENCODE_RELATIVE_PID_KP, HERO_YAW_ENCODE_RELATIVE_PID_KI, HERO_YAW_ENCODE_RELATIVE_PID_KD);
    ...
    //��ʼ��pitch���pid
    gimbal_PID_init(&init->gimbal_pitch_motor.gimbal_motor_absolute_angle_pid, HERO_PITCH_GYRO_ABSOLUTE_PID_MAX_OUT, HERO_PITCH_GYRO_ABSOLUTE_PID_MAX_IOUT, HERO_PITCH_GYRO_ABSOLUTE_PID_KP, HERO_PITCH_GYRO_ABSOLUTE_PID_KI, HERO_PITCH_GYRO_ABSOLUTE_PID_KD);
    gimbal_PID_init(&init->gimbal_pitch_motor.gimbal_motor_relative_angle_pid, HERO_PITCH_ENCODE_RELATIVE_PID_MAX_OUT, HERO_PITCH_ENCODE_RELATIVE_PID_MAX_IOUT, HERO_PITCH_ENCODE_RELATIVE_PID_KP, HERO_PITCH_ENCODE_RELATIVE_PID_KI, HERO_PITCH_ENCODE_RELATIVE_PID_KD);
    ...
    //��ʼ��yaw���pid
    gimbal_PID_init(&init->gimbal_yaw_motor.gimbal_motor_absolute_angle_pid, INFANTRY_YAW_GYRO_ABSOLUTE_PID_MAX_OUT, INFANTRY_YAW_GYRO_ABSOLUTE_PID_MAX_IOUT, INFANTRY_YAW_GYRO_ABSOLUTE_PID_KP, INFANTRY_YAW_GYRO_ABSOLUTE_PID_KI, INFANTRY_YAW_GYRO_ABSOLUTE_PID_KD);
    gimbal_PID_init(&init->gimbal_yaw_motor.gimbal_motor_relative_angle_pid, INFANTRY_YAW_ENCODE_RELATIVE_PID_MAX_OUT, INFANTRY_YAW_ENCODE_RELATIVE_PID_MAX_IOUT, INFANTRY_YAW_ENCODE_RELATIVE_PID_KP, INFANTRY_YAW_ENCODE_RELATIVE_PID_KI, INFANTRY_YAW_ENCODE_RELATIVE_PID_KD);
    PID_init(&init->gimbal_yaw_motor.gimbal_motor_gyro_pid, PID_POSITION, Yaw_speed_pid, YAW_SPEED_PID_MAX_OUT, YAW_SPEED_PID_MAX_IOUT);
    //��ʼ��pitch���pid
    gimbal_PID_init(&init->gimbal_pitch_motor.gimbal_motor_absolute_angle_pid, INFANTRY_PITCH_GYRO_ABSOLUTE_PID_MAX_OUT, INFANTRY_PITCH_GYRO_ABSOLUTE_PID_MAX_IOUT, INFANTRY_PITCH_GYRO_ABSOLUTE_PID_KP, INFANTRY_PITCH_GYRO_ABSOLUTE_PID_KI, INFANTRY_PITCH_GYRO_ABSOLUTE_PID_KD);
    gimbal_PID_init(&init->gimbal_pitch_motor.gimbal_motor_relative_angle_pid, INFANTRY_PITCH_ENCODE_RELATIVE_PID_MAX_OUT, INFANTRY_PITCH_ENCODE_RELATIVE_PID_MAX_IOUT, INFANTRY_PITCH_ENCODE_RELATIVE_PID_KP, INFANTRY_PITCH_ENCODE_RELATIVE_PID_KI, INFANTRY_PITCH_ENCODE_RELATIVE_PID_KD);
    ...
    //��ʼ��yaw���pid
    gimbal_PID_init(&init->gimbal_yaw_motor.gimbal_motor_absolute_angle_pid, SENTINEL_YAW_GYRO_ABSOLUTE_PID_MAX_OUT, SENTINEL_YAW_GYRO_ABSOLUTE_PID_MAX_IOUT, SENTINEL_YAW_GYRO_ABSOLUTE_PID_KP, SENTINEL_YAW_GYRO_ABSOLUTE_PID_KI, SENTINEL_YAW_GYRO_ABSOLUTE_PID_KD);
    gimbal_PID_init(&init->gimbal_yaw_motor.gimbal_motor_relative_angle_pid, SENTINEL_YAW_ENCODE_RELATIVE_PID_MAX_OUT, SENTINEL_YAW_ENCODE_RELATIVE_PID_MAX_IOUT, SENTINEL_YAW_ENCODE_RELATIVE_PID_KP, SENTINEL_YAW_ENCODE_RELATIVE_PID_KI, SENTINEL_YAW_ENCODE_RELATIVE_PID_KD);
    PID_init(&init->gimbal_yaw_motor.gimbal_motor_gyro_pid, PID_POSITION, Yaw_speed_pid, YAW_SPEED_PID_MAX_OUT, YAW_SPEED_PID_MAX_IOUT);
    //��ʼ��pitch���pid
    gimbal_PID_init(&init->gimbal_pitch_motor.gimbal_motor_absolute_angle_pid, SENTINEL_PITCH_GYRO_ABSOLUTE_PID_MAX_OUT, SENTINEL_PITCH_GYRO_ABSOLUTE_PID_MAX_IOUT, SENTINEL_PITCH_GYRO_ABSOLUTE_PID_KP, SENTINEL_PITCH_GYRO_ABSOLUTE_PID_KI, SENTINEL_PITCH_GYRO_ABSOLUTE_PID_KD);
    gimbal_PID_init(&init->gimbal_pitch_motor.gimbal_motor_relative_angle_pid, SENTINEL_PITCH_ENCODE_RELATIVE_PID_MAX_OUT, SENTINEL_PITCH_ENCODE_RELATIVE_PID_MAX_IOUT, SENTINEL_PITCH_ENCODE_RELATIVE_PID_KP, SENTINEL_PITCH_ENCODE_RELATIVE_PID_KI, SENTINEL_PITCH_ENCODE_RELATIVE_PID_KD);  
#endif	
